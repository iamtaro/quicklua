local Robot = class("Robit", function()
	...
	return display.newSprite("#bdmonster055-stand2-0000.png")
end)
...
function Robot:createIdleAction()
	...
	local frames = display.newFrames("bdmonster055-stand2-00%02d.png",0,5)
...
function Robot:createAttackAction()
	...
	local frames = display.newFrames("bdmonster055-atk1-00%02d.png",0,8)
...
function Robot:createWalkAction()
	...
	local frames = display.newFrames("bdmonster055-run2-00%02d.png",0,7)
	local animation = display.newAnimation(frames,1/12)
...
function Robot:createKnockOutAction()
	...
	local frames = display.newFrames("bdmonster055-die-00%02d.png",1,8)
	local animation = display.newAnimation(frames,1/12)
